...
/**
 * successor - This will get next successor, the min node in the right subtree
 * @node: tree to check
...
/**
 * bst_remove - This will remove a node from a BST tree
...
/**
 * avl_remove - This will remove a node from a AVL tree
 * @root: The root of the tree
 * @value: The node with this value to remove
 * Return: Tree changed
 */
